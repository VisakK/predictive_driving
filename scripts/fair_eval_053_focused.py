"""Focused fair eval for experiment 053 (anomaly attention + risk-temperature bias).

Evaluates the 053 model with the same 500-seed protocol as
fair_eval_v3_archetype.py, then writes a comparison report against
052 and cached priors (Baseline, ExpectedInput-H10, ViT-only-v3).
"""
...
SHORT = "AnomAttn-Risk-v3"
NAME = "AnomalyAttention + Risk-Temp on v3 (053)"
...
def main():
    ...
    # Build comparison report against 052 + cached priors.
    ...
    md = []
    md.append(f"# 053 — Anomaly Attention + Risk-Temperature vs. priors\n")
    ...
    md.append("Compared models: AnomalyAttention+Risk-Temp (053), AnomalyAttention (052), "
